 ...
 *
 */
public class SparkWordCount_3stages {
  ...
  public static void main(String[] args) throws Exception {
    ...
    SparkConf conf =
        new SparkConf().setAppName(SparkWordCount_3stages.class.getName()).setMaster(master);
    ...
    JavaRDD<String> words =
        lines.flatMap(new FlatMapFunction<Tuple2<LongWritable, Text>, String>() {
          // output input
          @Override
          public Iterator<String> call(Tuple2<LongWritable, Text> tuple) {
            return Util.convertStringToWords(tuple._2.toString(), N).iterator();
          }
        });
    ...
    JavaPairRDD<String, Long> ones =
        // input K V
        words.mapToPair(new PairFunction<String, String, Long>() {
          // K V input
          @Override
